...
#endif
extern LIBICONV_DLL_EXPORTED __declspec (dllimport) iconv_t iconv_open (const char* tocode, const char* fromcode);
...
#endif
extern LIBICONV_DLL_EXPORTED __declspec (dllimport) size_t iconv (iconv_t cd,  char* * inbuf, size_t *inbytesleft, char* * outbuf, size_t *outbytesleft);

/* Frees resources allocated for conversion descriptor ‘cd’. */
#ifndef LIBICONV_PLUG
#define iconv_close libiconv_close
#endif
extern LIBICONV_DLL_EXPORTED __declspec (dllimport) int iconv_close (iconv_t cd);
